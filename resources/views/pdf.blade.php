...
<body>
        ...
        <div class="container d-flex align-items-center">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="nav-link scrollto active" href="{{ route('pdf') }}">PDFs</a></li>
    ...
    <div class="row" style="margin-top: 100px;">
        @foreach ($post as $post)
            @if (Str::endsWith(strtolower($post->image), ['.pdf']))
                <div class="column">
                    <div class="card" >
                        <img class="card-img-top" src="{{ file_exists('public/PDFs/'.$post->image) ? asset('Images/'.$post->image) : asset('https://play-lh.googleusercontent.com/9XKD5S7rwQ6FiPXSyp9SzLXfIue88ntf9sJ9K250IuHTL7pmn2-ZB0sngAX4A2Bw4w') }}" alt="{{ $post->Title }}" width="200px" height="300px">
