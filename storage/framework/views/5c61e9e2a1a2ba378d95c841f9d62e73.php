...
<body>
        ...
        <div class="container d-flex align-items-center">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="nav-link scrollto" href="<?php echo e(route('image')); ?>">Images</a></li>
              <li><a class="nav-link scrollto active" href="<?php echo e(route('pdf')); ?>">PDFs</a></li>
    ...
    <div class="row" style="margin-top: 100px;">
        <?php $__currentLoopData = $post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(Str::endsWith(strtolower($post->image), ['.pdf'])): ?>
                <div class="column">
                    <div class="card" >
                        <img class="card-img-top" src="<?php echo e(file_exists('public/PDFs/'.$post->image) ? asset('Images/'.$post->image) : asset('https://play-lh.googleusercontent.com/9XKD5S7rwQ6FiPXSyp9SzLXfIue88ntf9sJ9K250IuHTL7pmn2-ZB0sngAX4A2Bw4w')); ?>" alt="<?php echo e($post->Title); ?>" width="200px" height="300px">
...
</html><?php /**PATH C:\Users\amban\OneDrive\Desktop\File_Uploading_Website\File_Upload\resources\views/pdf.blade.php ENDPATH**/ ?>