        ...
        <div class="container d-flex align-items-center">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="nav-link scrollto active" href="<?php echo e(route('view_posts')); ?>">View Post</a></li>
    ...
    <div class="row" style="margin-top: 100px;">
        ...
        <div class="column">
            <div class="card">
               ...
               <img class="card-img-top" src="<?php echo e(file_exists(public_path('Images/'.$post->image)) ? asset('Images/'.$post->image) : asset('https://play-lh.googleusercontent.com/83sCGxIWuDo2nr4_dqgBbQUPwc-Qs_Ssp99mugxqcPdElbavO8ZXZYIWyXbu-SLEUA')); ?>" alt="<?php echo e($post->Title); ?>" width="200px" height="300px">
...
</html><?php /**PATH C:\Users\amban\OneDrive\Desktop\File_Uploading_Website\File_Upload\resources\views/viewpost.blade.php ENDPATH**/ ?>