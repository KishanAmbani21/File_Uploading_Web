...
<body>
        ...
        <div class="container d-flex align-items-center">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="nav-link scrollto active" href="<?php echo e(route('doc')); ?>">Docs</a></li>
    ...
    <div class="row" style="margin-top: 100px;">
        <?php $__currentLoopData = $post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(Str::endsWith(strtolower($post->image), ['.doc','.docx','.txt'])): ?>
                <div class="column">
                    <div class="card">
                        <img class="card-img-top" src="<?php echo e(file_exists('public/DOCs/'.$post->image) ? asset('Images/'.$post->image) : asset('https://img.freepik.com/premium-vector/modern-flat-design-doc-file-icon-web_599062-7102.jpg')); ?>" alt="<?php echo e($post->Title); ?>" width="200px" height="300px">
...
</html><?php /**PATH C:\Users\amban\OneDrive\Desktop\File_Uploading_Website\File_Upload\resources\views/doc.blade.php ENDPATH**/ ?>